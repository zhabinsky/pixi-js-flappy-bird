const attachDisplayProperty = PIXI => {
  ...
  (function (pixi_display) {
    var LayerTextureCache = (function () {
      ...
      LayerTextureCache.prototype.pushTexture = function (renderer) {
        ...
        this._tempRenderTargetSource.copyFrom (
        ...
        if (filterStack.length > 1) {
          filterStack[filterStack.length - 1].renderTexture =
      ...
      LayerTextureCache.prototype.popTexture = function (renderer) {
        ...
        if (filterStack.length > 1) {
          ...
          ].renderTexture = this._tempRenderTarget;
        }
  ...
  (function (pixi_display) {
    ...
    var LayersTreeSearch = (function () {
      ...
      LayersTreeSearch.prototype.recursiveFindHit = function (
        point,
        displayObject,
        hitTestOrder,
        interactive,
        ...
        if (displayObject.interactiveChildren && children) {
          for (var i = children.length - 1; i >= 0; i--) {
            ...
            var hitChild = this.recursiveFindHit (
              point,
              child,
              hitTestOrder,
              interactiveParent,
      ...
      LayersTreeSearch.prototype.findHit = function (
        strangeStuff,
        displayObject,
        func,
        hitTest
      ...
      LayersTreeSearch.prototype._finishInteractionProcess = function (
        event,
        func
      ) {
        var queue = this._queue;
...
export default attachDisplayProperty;
