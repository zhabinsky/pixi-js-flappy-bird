...
* create `src/index.html`。
  ...
  ```
* create entry js file `src/src/main.js`.
...
* create start command at `script`section in `package.json` file.
  ...
  ```
* now we have import the `webpack` successfully, run `npm start` to start the project, it will open google chrome browser automatically,the game is running！try to modify the `src/src/main.js` file and save,the page will refresh automatically and we can see the modification has taken effect！
